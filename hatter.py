...
#    if lista[0]=="X" and lista[1] and lista[2] or lista[3] and lista[4] and lista[5] or lista[6] and lista[7] and lista[8] or lista[0] and lista[4] and lista[7] or lista[2] and lista[4] and lista[6] or lista[0] and lista[3] and lista[6] or lista[1] and lista[4] and lista[7] or lista[2] and lista[5] and lista[8] == "X" or "O":
#        print("véget ért'")
#        return True
